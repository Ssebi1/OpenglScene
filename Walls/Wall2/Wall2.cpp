...
void Wall2::CreateVBO(GLuint& VaoId, GLuint& VboId, GLuint& EboId)
{
	// varfurile 
	GLfloat Vertices[] =
	{
...
void Wall2::draw(GLuint ProgramId, GLuint& VaoId, GLuint codCol, GLuint matrixLocation, GLuint codColLocation) {
	glBindVertexArray(VaoId);
