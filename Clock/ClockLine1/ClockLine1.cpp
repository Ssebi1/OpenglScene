...
void ClockLine1::CreateVBO(GLuint& VaoId, GLuint& VboId, GLuint& EboId)
{
	// varfurile 
	GLfloat Vertices[] =
	{
		...
		// varfuri "ground"
		-10.0f,  -1430.0f, 800.0f, 1.0f,  1.0f, 1.0f, 1.0f,  0.0f, 0.0f, 1.0f,
		10.0f,  -1430.0f, 800.0f, 1.0f,  1.0f, 1.0f, 1.0f,  0.0f, 0.0f, 1.0f,
		10.0f,  -1430.0f, 950.0f, 1.0f,  1.0f, 1.0f, 1.0f,  0.0f, 0.0f, 1.0f,
		-10.0f,  -1430.0f, 950.0f, 1.0f,  1.0f, 1.0f, 1.0f,  0.0f, 0.0f, 1.0f
	};
...
void ClockLine1::draw(GLuint& VaoId, GLuint codCol, GLuint matrixLocation, GLuint codColLocation) {
	glBindVertexArray(VaoId);
	...
	myMatrix = glm::rotate(myMatrix, (60 - ltm->tm_min) * (CLOCK_HOUR/60), glm::vec3(0.0f, 1.0f, 0.0f));
	myMatrix = glm::translate(myMatrix, glm::vec3(0.0f, 0.0f, -800.0f));
