...
void Floor::CreateVBO(GLuint &VaoId, GLuint &VboId, GLuint &EboId)
{
	// varfurile 
	GLfloat Vertices[] =
	{
		...
		// varfuri "ground"
		-1500.0f,  -1500.0f, 0.0f, 1.0f, 0.45f, 0.25f, 0.1f,  0.0f, 0.0f, 1.0f,
		1500.0f,  -1500.0f, 0.0f, 1.0f, 0.45f, 0.25f, 0.1f,  0.0f, 0.0f, 1.0f,
		1500.0f,  1500.0f,  0.0f, 1.0f,  0.45f, 0.25f, 0.1f,  0.0f, 0.0f, 1.0f,
		-1500.0f,  1500.0f,  0.0f, 1.0f,  0.45f, 0.25f, 0.1f,  0.0f, 0.0f, 1.0f
	};
...
void Floor::draw(GLuint& VaoId, GLuint codCol, GLuint matrixLocation, GLuint codColLocation) {
	glBindVertexArray(VaoId);
